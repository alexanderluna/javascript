...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Ups = __webpack_require__(98);

	var _Ups2 = _interopRequireDefault(_Ups);
	...
	(0, _reactDom.render)(_react2.default.createElement(
	        ...
	        _react2.default.createElement(_reactRouter.Route, { path: '*', component: _Ups2.default })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SkiDayCount = __webpack_require__(28);

	var _SkiDayCount2 = _interopRequireDefault(_SkiDayCount);

	var _SkiDayList = __webpack_require__(37);

	var _SkiDayList2 = _interopRequireDefault(_SkiDayList);

	var _AddDayForm = __webpack_require__(96);
	  ...
	  function App(props) {
	    ...
	    _this.state = {
	      allSkiDays: [{
	        ...
	        mountain: "Hartz",
	        date: new Date("5/4/2012"),
	        snow: true,
	        hike: true
	      }, {
	        mountain: "Reichenbach",
	        date: new Date("4/5/1891"),
	        snow: false,
	        hike: false
	      }]
	    }; // state
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        this.props.location.pathname === "/" ? React.createElement(_SkiDayCount2.default, { total: this.countDays(),
	          snow: this.countDays("snow"),
	          hike: this.countDays("hike") }) : this.props.location.pathname === "/add-day" ? React.createElement(_AddDayForm2.default, null) : React.createElement(_SkiDayList2.default, { days: this.state.allSkiDays })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SkiDayCount = function (_Component) {
	  _inherits(SkiDayCount, _Component);

	  function SkiDayCount() {
	    _classCallCheck(this, SkiDayCount);

	    return _possibleConstructorReturn(this, (SkiDayCount.__proto__ || Object.getPrototypeOf(SkiDayCount)).apply(this, arguments));
	  }

	  _createClass(SkiDayCount, [{
	    key: 'toPercentage',
	    ...
	    value: function toPercentage(decimal) {
	      return decimal * 100 + "%";
	    }
	  }, {
	    key: 'goalProgress',
	    value: function goalProgress(total, goal) {
	    ...
	    value: function render() {
	      return React.createElement(
	        'div',
	        null,
	        React.createElement('aside', { 'class': 'col-md-3' }),
	        React.createElement(
	          'div',
	          { 'class': 'col-md-6' },
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'span',
	                null,
	                this.goalProgress(this.props.total, this.props.goal)
	              )
	            )
	          )
	        )
	  ...
	  return SkiDayCount;
	}(_react.Component); // class

	SkiDayCount.propTypes = {
	  total: _propTypes2.default.number,
	  snow: _propTypes2.default.number,
	  hike: _propTypes2.default.number,
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/autoprefixer-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./custom.scss", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/autoprefixer-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./custom.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body {\n  background-color: #f9f9ff; }\n\n#root {\n  width: 100%; }\n\n.navbar {\n  margin-top: 0.5em; }\n\n.ski-day-count {\n  margin-top: 2em;\n  margin-bottom: 2em;\n  border: 0.5em solid #65657f;\n  border-radius: 0.5em;\n  padding: 1em; }\n  .ski-day-count div {\n    background-color: purple;\n    border-radius: 0.5em;\n    margin: 1em;\n    padding: 1.5em;\n    text-align: center; }\n    .ski-day-count div span {\n      color: white;\n      font-size: 2em; }\n  .ski-day-count .goal {\n    background-color: rgba(69, 53, 144, 0.97); }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SkiDayList = function (_Component) {
	  _inherits(SkiDayList, _Component);

	  function SkiDayList() {
	    _classCallCheck(this, SkiDayList);

	    return _possibleConstructorReturn(this, (SkiDayList.__proto__ || Object.getPrototypeOf(SkiDayList)).apply(this, arguments));
	  }

	  _createClass(SkiDayList, [{
	    key: 'render',
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              this.props.days.map(function (day, i) {
	                return React.createElement(_SkiDayRow2.default, _extends({ key: i }, day));
	              })
	            )
	          )
	        ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SkiDayRow = function (_Component) {
	  _inherits(SkiDayRow, _Component);

	  function SkiDayRow() {
	    _classCallCheck(this, SkiDayRow);

	    return _possibleConstructorReturn(this, (SkiDayRow.__proto__ || Object.getPrototypeOf(SkiDayRow)).apply(this, arguments));
	  }

	  _createClass(SkiDayRow, [{
	    key: 'render',
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(
	          'td',
	          null,
	          this.props.snow ? React.createElement(
	            'span',
	            null,
	            '\u2603'
	          ) : null
	        ...
	        React.createElement(
	          'td',
	          null,
	          this.props.hike ? React.createElement(
	            'span',
	            null,
	            'HIKE!!!'
	          ) : null
	...
	SkiDayRow.propTypes = {
	  ...
	  mountain: _propTypes2.default.string.isRequired,
	  snow: _propTypes2.default.bool.isRequired,
	  hike: _propTypes2.default.bool.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _match2 = __webpack_require__(70);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddDayForm = function (_Component) {
	  _inherits(AddDayForm, _Component);

	  function AddDayForm() {
	    _classCallCheck(this, AddDayForm);

	    return _possibleConstructorReturn(this, (AddDayForm.__proto__ || Object.getPrototypeOf(AddDayForm)).apply(this, arguments));
	  }
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'button',
	              { type: 'button', 'class': 'navbar-toggle collapsed', 'data-toggle': 'collapse', 'data-target': '#myNav', 'aria-expanded': 'false' },
	              React.createElement(
	                'span',
	                { 'class': 'sr-only' },
	                'Toggle navigation'
	          ...
	          React.createElement(
	            'div',
	            { 'class': 'collapse navbar-collapse', id: 'myNav' },
	            React.createElement(
	              'ul',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ups404 = function (_Component) {
	  _inherits(Ups404, _Component);

	  function Ups404() {
	    _classCallCheck(this, Ups404);

	    return _possibleConstructorReturn(this, (Ups404.__proto__ || Object.getPrototypeOf(Ups404)).apply(this, arguments));
	  }
